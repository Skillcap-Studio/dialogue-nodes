...
const VariablesScene = preload("res://addons/skillcap_dialogue_nodes/editor/Variables.tscn")
const GraphScene = preload("res://addons/skillcap_dialogue_nodes/editor/Graph.tscn")

var file_icon := preload('res://addons/skillcap_dialogue_nodes/icons/Script.svg')
var cur_idx := -1
var deletion_queue := []
